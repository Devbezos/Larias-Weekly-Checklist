...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "if_available_complete_the_weekly_saltheril_s_soiree_in_eversong_woods", text = "If available, complete the weekly Saltheril's Soiree in Eversong Woods." },
            { id = "if_available_complete_the_weekly_abundance_event_in_zul_aman", text = "If available, complete the weekly Abundance Event in Zul'aman." },
            ...
            { id = "if_available_complete_the_weekly_stormarion_assault_in_the_voidstorm", text = "If available, complete the weekly Stormarion Assault in the Voidstorm." },
