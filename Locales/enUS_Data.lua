...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "825bfe20", text = "Level characters warmode on to 90 - DMF opens Sunday for 10% more exp. NO LONGER GIVES RENOWN" },
            { id = "50f90465", text = "If available, complete the weekly Saltheril's Soiree in Eversong Woods. - NOT AVAILABLE IN EARLY ACCESS" },
            { id = "7644d082", text = "If available, complete the weekly Abundance Event in Zul'aman. - BUGGED IN EARLY ACCESS - DONT DO" },
            { id = "6892e5d5", text = "If available, complete the weekly Legends of the Haranir event in Harandar." },
            { id = "f466c57b", text = "If available, complete the weekly Stormarion Assault in the Voidstorm. - AVAILABLE IN EARLY ACCESS" },
            ...
            { id = "4e99ff6e", text = "Complete side quest chains for renown. (can be done on alts to level at same time). NEW: DARKMOON FAIRE NO LONGER GIVES A RENOWN BUFF!" },
        },
    },
    {
        id = "50281d6f",
        ...
        items = {
            ...
            { id = "fe628d60", text = "Raise The Singularity renown to rank 7 for 1/6 champion trinket - available in early access" },
            { id = "9b594c78", text = "Raise Hara'ti renown to rank 8 for 1/6 champion belt" },
            { id = "6c01e9d5", text = "Raise Silvermoon renown to rank 9 for 1/6 champion helm - NOT available in early access" },
            { id = "484f13d6", text = "Raise Amani Tribe renown to rank 9 for 1/6 champion necklace" },
    ...
    },
    {
        ...
        items = {
            ...
            { id = "dd71541a", text = "Complete a World Tour of M0 dungeons - rewards champ ilvl" },
