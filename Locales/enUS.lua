...
local STRINGS = {
	...
	CURRENCY_CONFIG_HELP = "Add by currency ID, toggle rows on or off, Alt+left-click to move one to the front, or right-click to remove it.",
	...
	CURRENCY_CONFIG_TOOLTIP_REORDER = "Alt+left-click moves this currency to the front.",
	...
	CURRENCY_CONFIG_TOOLTIP_RESTORE_FRONT = "Alt+left-click restores it and moves it to the front.",
