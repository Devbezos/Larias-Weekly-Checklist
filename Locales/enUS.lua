...
local STRINGS = {
	...
	ALT_SUMMARY_ACHIEVEMENT_ILVL_NOTE = "* This item level is calculated using watermarks. Your lowest ilvl ring, trinket, or weapon is used until both matching slots are the same ilvl. *",
